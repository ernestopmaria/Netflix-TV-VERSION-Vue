  ...
  <div class="fixed w-full h-screen bg-black">
    ...
    <div v-if="!showFullVideo">
      ...
      <div class="fixed z-30 bottom-0 right-0 w-full h-[55%] pl-[120px] overflow-y-auto">
        <VideoCarousel :movies="movies[0]" category="Popular Movies" class="pb-14 pt-14" />
        <VideoCarousel :movies="movies[1]" category="Horror Movies" class="pb-14" />
        <VideoCarousel :movies="movies[2]" category="Featured Movies" class="pb-32" />
      </div>
    </div>
